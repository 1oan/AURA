...
public class GetMyAllocationQueryHandlerTests
{
    ...
    public async Task Handle_HasActiveAllocation_ReturnsDto()
    {
        ...
        _allocations.FindActiveByUserAndPeriodAsync(userId, periodId, Arg.Any<CancellationToken>())
            .Returns(allocation);
    ...
    public async Task Handle_NoActiveAllocation_ReturnsNull()
    {
        ...
        _allocations.FindActiveByUserAndPeriodAsync(Arg.Any<Guid>(), Arg.Any<Guid>(), Arg.Any<CancellationToken>())
